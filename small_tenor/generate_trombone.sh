...
#"$openscad" -o output/bell_top.stl -Dpart=\"bell_top\" ./small_tenor.scad &
"$openscad" -o output/bell_middle.stl -Dpart=\"bell_middle\" ./small_tenor.scad &
...
#"$openscad" -o output/bell_bottom.stl -Dpart=\"bell_bottom\" ./small_tenor.scad &
"$openscad" -o output/neckpipe_bottom.stl -Dpart=\"neckpipe_bottom\" ./small_tenor.scad &
#"$openscad" -o output/neckpipe_top.stl -Dpart=\"neckpipe_top\" ./small_tenor.scad &
#"$openscad" -o output/tuning_slide.stl -Dpart=\"tuning_slide\" ./small_tenor.scad &
