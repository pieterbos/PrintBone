...
function inner_lip(joint_clearance=0.12) = 
...
module top_joint(polygon, rotate=false, joint_clearance=0.12, solid=false) {
...
module bottom_joint(polygon, rotate=false, joint_clearance=0.12, solid=false) {
    difference() {
...
module flat_bottom_joint(full_curve, min_height, max_height, bell_thickness, joint_clearance=0.12) {
